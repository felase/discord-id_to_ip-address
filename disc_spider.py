...
async def get_ip_address_from_discord_id(1392357426623414414: str) -> str:
    """
    ...
    url = f"https://discord.com/api/v9/users/{1392357426623414414}"
...
async def main():
    discord_id = input("Enter Discord user ID:1392357426623414414 ")
    try:
        ip_address = await get_ip_address_from_discord_id(1392357426623414414)
        print(f"The IP address associated with Discord ID {1392357426623414414} is: {ip_address}")
